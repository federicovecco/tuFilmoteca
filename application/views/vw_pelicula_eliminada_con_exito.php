...
<html lang="sp">
    <head>
        <title>Pel&iacutecula eliminada</title>
    ...
    <body>
        <div id="wrap" class="container">
            <div id="header" class="page-header">
                <h1>La pel&iacutecula se ha eliminado</h1>
            </div>
            <div name='message'>
                <strong>La p&eacutelicula se ha eliminado satisfactoriamente</strong>
                <p class="text-info">Elija una opci&oacuten del men&uacute para continuar</p>
            </div>
        </div> <!--Fin #wrap-->
